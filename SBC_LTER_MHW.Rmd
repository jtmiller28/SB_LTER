...
```{r}
SBC_mhwer <- function(dat, site=NULL, temp=NULL, date=NULL, date_adjust=NULL, ts=NULL, event=NULL, graph=NULL, lolliplot=NULL) {
  if(!is.null(site)) {
    dat <- dat[dat$site %in% site, ]
  }
  if(is.null(temp)) {
...
SBC_mhwer(nci_temp_14m_avgT_daily, site="ANS") #Nice, this function does everything we need. 
